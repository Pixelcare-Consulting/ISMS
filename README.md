...
| **Planogram** | Clickable cards filter empty / below-max / MIL branches; per-branch SKU shelf capacity and MIL; official Excel template download + import (bulk); Add model requires Allowed models first |

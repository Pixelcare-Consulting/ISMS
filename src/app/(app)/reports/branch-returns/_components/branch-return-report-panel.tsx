...
export function BranchReturnReportPanel() {
    ...
    <div className="max-w-xl space-y-4 rounded-xl border bg-card p-4 shadow-sm sm:p-6">
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="branch-return-from">From date</Label>
          <Input
            id="branch-return-from"
            type="date"
            value={from}
        ...
        <div className="space-y-2">
          <Label htmlFor="branch-return-to">To date</Label>
          <Input
            id="branch-return-to"
            type="date"
            value={to}

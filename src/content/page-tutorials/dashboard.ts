...
export const DASHBOARD_PAGE_TUTORIAL: PageTutorialContent = {
  ...
  dialogDescription:
    "Your home screen shows activity cards for your role, inventory mix, planning alerts, a monthly snapshot, the order pipeline, and a Sales overview when you can access Sales & ATR.",
  helpHref: "/help",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Sales overview (when you have Sales access) shows this month’s sales and amount, open ATR, returns in progress, sale status mix, ATR/return pipeline, and top branches and models — each card links to Sales & ATR.",
    ...
    },
    {
      title: "Next steps",
      description:
        "Use Help & Support for full workflow guides. Daily execution usually continues in Orders, Operations, Inventory, or Sales.",
    },
  ],
};

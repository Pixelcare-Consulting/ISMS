...
export const PLANNING_PAGE_TUTORIAL: PageTutorialContent = {
  ...
  dialogDescription:
    "Switch the period, set branch targets, run shelf allocation, and generate suggested auto-replenish orders.",
  helpHref: "/help",
  ...
  sections: [
    {
      ...
      description:
        "Planning holds the official forecast for a period — a peso target per branch — then compares shelf capacity to stock so you can generate suggested auto-replenish drafts.",
    },
    {
      title: "How to use it",
      bullets: [
        ...
        "Generate suggested orders, then review them under Planning → Suggested orders. Branch orders still go through TL / SP approval after suggestions become real orders.",
      ],
    },
    {
      title: "Related pages",

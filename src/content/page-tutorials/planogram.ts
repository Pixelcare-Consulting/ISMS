  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Each branch row shows allowed SKUs as tags. Open a branch to add or remove a SKU. Add model needs Allowed models first — if that list is empty, you get a shortcut to open it.",

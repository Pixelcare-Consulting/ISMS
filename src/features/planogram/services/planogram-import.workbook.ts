...
const BRS_LAYOUT_ERROR =
  "This file is the old BRS forecast/planogram layout, not the Planogram template. Download the template (sap_code, sku, max_qty, mil_days). Upload the BRS file under Planning → Import forecast.";

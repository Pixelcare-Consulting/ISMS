...
export const REASON_STATUS_DEFAULTS: ReasonStatusDefaultGroup[] = [
  ...
  },
  {
    ...
    codes: [
      ...
      { code: "pending", name: "Pending acceptance", sortOrder: 3 },
      { code: "accepted", name: "Accepted", sortOrder: 4 },
      { code: "rejected", name: "Rejected", sortOrder: 5 },
      { code: "partial", name: "Partially accepted", sortOrder: 6 },
    ],
  },
  {
    ...
    codes: [
      { code: "requested", name: "Requested", sortOrder: 1 },
      { code: "approved", name: "Approved", sortOrder: 2 },
      { code: "draft", name: "Draft", sortOrder: 3 },
      { code: "pending_tl", name: "Pending TL", sortOrder: 4 },
      { code: "for_transfer", name: "For transfer", sortOrder: 5 },
      { code: "in_transit", name: "In transit", sortOrder: 6 },
      { code: "accepted", name: "Accepted", sortOrder: 7 },
      { code: "rejected", name: "Rejected", sortOrder: 8 },
      { code: "completed", name: "Completed", sortOrder: 9 },
      { code: "cancelled", name: "Cancelled", sortOrder: 10 },
    ],
  },
  {
    ...
    codes: [
      ...
      { code: "approved", name: "Approved", sortOrder: 2 },
      { code: "draft", name: "Draft", sortOrder: 3 },
      { code: "pending_tl", name: "Reserve pull-out", sortOrder: 4 },
      { code: "for_pullout", name: "For pull-out", sortOrder: 5 },
      { code: "scheduled", name: "Scheduled", sortOrder: 6 },
      { code: "pending_logistics", name: "Pending logistics", sortOrder: 7 },
      { code: "in_transit", name: "Pull-out in transit", sortOrder: 8 },
      { code: "pulled_out", name: "Pulled out", sortOrder: 9 },
      { code: "completed", name: "Completed", sortOrder: 10 },
      { code: "cancelled", name: "Cancelled", sortOrder: 11 },
    ],
  },
];

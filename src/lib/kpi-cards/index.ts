/**
 * Global KPI cards — single reusable KPI card UI for the whole app.
 * Track down: search "GlobalKpiCards" or import from `@/lib/kpi-cards`.
 */
export { GlobalKpiCards } from "@/lib/kpi-cards/global-kpi-cards";
export { KpiCard } from "@/lib/kpi-cards/kpi-card";
